...
class TestLine(TestCaseWithRunner):
    ...
    def test_replace_existing_line_start(self):
        ...
        self.check_apply()
        self.assertEqual(
            platform.get("/replace_existing_line_start"), b"FOO 2\nBAR 2\nBAZ 3"
        )
    ...
    def test_replace_existing_line_middle(self):
        ...
        self.check_apply()
        self.assertEqual(
            platform.get("/replace_existing_line_middle"), b"FOO 1\nBAR 1\nBAZ 3"
        )
    ...
    def test_replace_existing_line_end(self):
        ...
        self.check_apply()
        self.assertEqual(
            platform.get("/replace_existing_line_end"), b"FOO 1\nBAR 2\nBAZ 2"
        )
    ...
    def test_replace_existing_line_append(self):
        ...
        self.check_apply()
        self.assertEqual(
            platform.get("/replace_existing_line_append"), b"FOO 1\nBAR 2\nBAZ 3\nQUX 2"
        )
